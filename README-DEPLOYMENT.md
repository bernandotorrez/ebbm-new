# Deployment Guide - ebmp Application
...
# Atau manual:
docker exec -it ebmp_app php artisan livewire:delete-uploaded-files --hours=24
```

### Clear All Caches
```bash
docker exec -it ebmp_app php artisan optimize:clear
docker exec -it ebmp_app php artisan filament:clear-cached-components
docker compose restart
```
...
docker exec -it ebmp_app du -sh storage/app/livewire-tmp

# Cek jumlah files
docker exec -it ebmp_app find storage/app/livewire-tmp -type f | wc -l
```
