...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Recreate view with correct TBBM join (from tx_sp3m instead of tx_do)
        DB::statement("
            ...
            INNER JOIN ms_tbbm mt ON mt.tbbm_id = txsp3m.tbbm_id
            WHERE txdo.deleted_at IS NULL
              AND txdo.is_active = '1';
        ");
    }
    ...
    public function down(): void
    {
        ...
        // Recreate old view (with old structure)
        DB::statement("
            CREATE OR REPLACE VIEW view_laporan_detail_tagihan AS
            SELECT 
                txdo.tanggal_do AS tanggal_isi,
